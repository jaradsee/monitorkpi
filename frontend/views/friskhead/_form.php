...
<div class="friskhead-form">
   ...
   <div class="col-sm-6 col-md-6">
       <?= $form->field($model, 'clinictype')->dropdownList(
            ArrayHelper::map(Clinictype::find()->all(),
            'CLINICTYPE_ID',
            'CLINIC_NAME'),
            [
                'id'=>'ddl-clinictype',
     ...
     <div class="col-sm-6 col-md-6">
       <?= $form->field($model, 'level')->widget(DepDrop::classname(), [
            ...
            'pluginOptions'=>[
                ...
                'placeholder'=>'เลือกระดีบความรุนแรง...',
                'url'=>Url::to(['/riskhead/get-level'])
            ]
        ]); ?>
    </div>     
                   ...
                   'options' => ['multiple' => true,'accept' => 'image/*'], //'accept' => 'image/*' หากต้องเฉพาะ image
                    'pluginOptions' => [
                       ...
                       'initialPreview'=> $initialPreview,
                        ...
                        'uploadUrl' => Url::to(['/friskhead/upload-ajax']),
                        'uploadExtraData' => [
                            'ref' => $model->ref,
                        ],
                        'maxFileCount' => 100
