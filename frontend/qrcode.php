<?php
/* @var $this SiteController */$this->pageTitle=Yii::app()->name;
?><html>
<head>
...
<script type=”text/javascript” src=”data/llqrcode.js”></script>
<script type=”text/javascript” src=”data/webqr.js”></script>
